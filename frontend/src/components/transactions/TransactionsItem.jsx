...
const TransactionsItem = ({ data }) => {
  ...
  return (
    <div
      className={twMerge("grid mid:grid-cols-[1fr_4fr_23fr_6fr_1fr] max-mid:grid-cols-[1fr_8fr_18fr_10fr_1fr] max-esml:grid-cols-[1fr_4fr_3fr] text-[var(--color-text)] items-center text-xl esml:gap-2.5 max-esml:gap-[5px] items-border animate-fade-in")}>
      <div className={"flex flex-col max-esml:p-[15px_0] max-esml:justify-center max-esml:row-span-3 items-center text-[var(--color-text)] font-bold gap-2.5"}>
