...
const ConfirmationDialog = ({ onReject, onAccept, text }) => {
  return createPortal(
    <div className={"z-[3000] w-[400px] h-[250px] window-center rounded-[15px] flex flex-col text-[var(--color-text)] font-bold"}>
      <div className={"bg-[var(--color-third)] h-[80%] p-[10px_15px]"}>
      ...
      <div className={"bg-[#901636] grow flex justify-around items-center gap-[10px] p-[7px_10px]"}>
        ...
        <Button className={"w-[50%] btn-classic jump-05 bg-[var(--color-comp)]"} onClick={onAccept}>Confirm</Button>
      </div>
    </div>, document.body);
}
