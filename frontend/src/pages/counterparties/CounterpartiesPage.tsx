...
const CounterpartiesPage = () => {
    ...
    const onCounterpartyCreate = useCallback(
        async () => onFormSubmit<CounterpartyGetClient>(
            ...
            addCounterparty as SubmitWithoutId<CounterpartyGetClient>,
            hideModal),
    ...
    const handleCreation = useCallback(() => {
        showModal({
            ...
            content: <CounterpartiesForm onSubmit={onCounterpartyCreate} ref={formRef}/>,
            saveFunc: onCounterpartyCreate,
            hideOnSave: false
        })
